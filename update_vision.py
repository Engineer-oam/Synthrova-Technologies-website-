...
with open('src/pages/Vision.tsx', 'r') as f:
    content = f.read()

# Replace the entire file with a minimalist dark section

new_vision = """import { useEffect, useRef } from "react";
...
with open('src/pages/Vision.tsx', 'w') as f:
    f.write(new_vision)
