    ...
    <div className="w-full selection:bg-synthrova-blue/30 selection:text-synthrova-black bg-synthrova-white">
      ...
      <section className="py-32 bg-synthrova-white text-synthrova-black">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <a 
            href={`mailto:${import.meta.env.VITE_SECURITY_CONTACT_EMAIL || "security-reports@synthrova.com"}`} 
          ...
          <p className="mt-8 text-xs font-mono text-synthrova-black/40">
            {!import.meta.env.VITE_SECURITY_CONTACT_EMAIL ? "Security contact information will be published here upon platform general availability." : `Direct contact: ${import.meta.env.VITE_SECURITY_CONTACT_EMAIL}`}
          </p>
        </div>
      </section>
