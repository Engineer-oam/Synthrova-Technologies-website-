...
# Replace the container width/height and add overflow-hidden
...
# Replace the img classes to allow cropping
content = content.replace(
...
content = content.replace(
    'className="relative w-48 h-10 transition-opacity duration-300 group-hover:opacity-70"',
